...
follow the [Running on DigitalOcean](/guides/running-on-digitalocean) guide or the
[Running on PlanetScale](/guides/running-on-planetscale) guide to get a database up and running.
You can also check out the **Managed databases** section under [Hosting](/guides/hosting).
