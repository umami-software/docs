...
database, you can follow the [Running on DigitalOcean](/guides/running-on-digitalocean) guide to get a database up and running. You
can also check out the **Managed databases** section under [Hosting](/guides/hosting).
