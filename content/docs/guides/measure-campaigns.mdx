...
data inside your Umami dashboards or build a custom [UTM report](/docs/utm). Google has a free [UTM link builder](https://ga-dev-tools.google/campaign-url-builder/) that
anyone can use.
