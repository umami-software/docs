...
1. Install Umami (v2.19.0) on a PostgreSQL server. Documentation for the installation process can be found [here](/docs/install).
...
- The file path (/tmp/website_event.csv) is on the MySQL server's filesystem, not necessarily your host.
