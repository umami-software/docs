...
![image](/images/docs/languages.png)
...
For example, here is the original English translation, [en-US.json](https://raw.githubusercontent.com/umami-software/umami/master/src/lang/en-US.json).

And here is it translated into German, [de-DE.json](https://raw.githubusercontent.com/umami-software/umami/master/src/lang/de-DE.json).
