---
title: Overview
description: Welcome to the Umami v2 documentation!
---
...
If you are unfamiliar with running your own servers, check out the [Hosting](https://umami.is/docs/guides/hosting) section to get a quick overview.

There are also many services that will run Umami. See the [Guides](https://umami.is/docs/guides/hosting) section.
