...
For detailed setup options, see [Installation](/docs/install). For managed hosting platforms, check out our [deployment guides](/guides/hosting).
...
- [Guides](/guides) — Step-by-step deployment tutorials for Vercel, Railway, DigitalOcean, and other platforms.
- [API Reference](/api) — Endpoints for authentication, websites, events, sessions, and more.
- [Cloud](/cloud) — Managed hosting if you'd rather not self-host.
