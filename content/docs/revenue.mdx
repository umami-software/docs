...
To start collecting revenue data, you will track an event with dynamic data. This can be done through [tracker functions](https://umami.is/docs/tracker-functions#event-data)
